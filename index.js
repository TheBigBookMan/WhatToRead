...
//* use postgres database and Prisma as the ORM

//* command line interface using nodejs (could try use python but think might take too long to learn)

//* use graphql as API

// * use inquirer for user to search the database based on criteria
